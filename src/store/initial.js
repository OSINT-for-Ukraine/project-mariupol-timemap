...
const initial = {
  ...
  domain: {
    ...
    notifications: [],
    artilleries: [
      {id: 1, title: "2A18 D-30", range: 15.3},
      {id: 2, title: "2S1 Gvozdika", range: 15.2},
      {id: 3, title: "2S3 Akatsiya", range: 19},
      {id: 4, title: "2S4 Tyulpan", range: 20},
      {id: 5, title: "BM-21", range: 20},
      {id: 6, title: "BM-27 Uragan", range: 35},
      {id: 7, title: "2S19 Msta-S", range: 29},
      {id: 8, title: "2A65 Msta-B", range: 24.7},
      {id: 9, title: "2A36 Giatsint-B", range: 30},
      {id: 10, title: "2S5 Giatsint-S", range: 37},
      {id: 11, title: "2S7 Pion", range: 37.5},
      {id: 12, title: "9K51M Tornado-G", range: 40},
      {id: 13, title: "BM-30", range: 70},
      {id: 14, title: "9K515 Tornado-S", range: 120},
      {id: 15, title: "9K79-1 Tochka-U", range: 120},
      {id: 16, title: "9K720 Iskander", range: 500},
      {id: 17, title: "S-300", range: 150}
    ]
  },
